#!/usr/bin/env python3
"""Testes determinísticos do verificador de pull GHCR, sem rede ou segredo."""
...
MODULE_PATH = Path(__file__).with_name("blindou-ghcr-pull-verify.py")
SPEC = importlib.util.spec_from_file_location("blindou_ghcr_pull_verify", MODULE_PATH)
...
class PullVerifierTests(unittest.TestCase):
    ...
    def test_image_contract_rejects_other_owners(self) -> None:
        valid = (
            "ghcr.io/gleisonsette/blindou-backend@sha256:" + "e" * 64
        )
