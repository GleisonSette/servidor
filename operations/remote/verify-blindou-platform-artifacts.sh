...
dispatch_v3_activation_function="$(sed -n '/^activate_dispatch_v3_runtime()/,/^}/p' \
  "${REMOTE_DIR}/blindou-deployctl")"
dispatch_v3_activation_preconditions_function="$(sed -n '/^require_dispatch_v3_activation_preconditions()/,/^}/p' \
  "${REMOTE_DIR}/blindou-deployctl")"
